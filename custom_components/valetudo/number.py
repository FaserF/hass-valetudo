...
class ValetudoNumberManager:
    ...
    def _try_add_numbers(self, device_id: str):
        ...
        if not any(isinstance(n, ValetudoVolumeNumber) for n in self._numbers[device_id]):
...
class ValetudoVolumeNumber(NumberEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        topic = f"valetudo/{self._mqtt_identifier}/SpeakerVolumeControlCapability/value/set"
